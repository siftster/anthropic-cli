...
var betaAgentsVersionsList = cli.Command{
	Name:    "list",
	Usage:   "List Agent Versions",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleBetaAgentsVersionsList,
	HideHelpCommand: true,
}

func handleBetaAgentsVersionsList(ctx context.Context, cmd *cli.Command) error {
	...
	params := anthropic.BetaAgentVersionListParams{}
